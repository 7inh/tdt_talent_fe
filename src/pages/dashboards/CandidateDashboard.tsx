        ...
        <div className="row">
          <div className="col-lg-3 col-md-12 col-sm-12 col-12">
            <div className="emp_dashboard_sidebar jb_cover">
              <img
              style={{minWidth: 208, minHeight: 208}}
                src={user.picture}
                ...
                <div className="skills jb_cover">
                  <div className="skill-item jb_cover">
                    ...
                    <div className="skills-progress">
                      <span data-value="70%" style={{ width: "70%" }} />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="job_filter_category_sidebar company_wrapper jb_cover">
                  ...
                  <div className="job_overview_header pdd jb_cover">
                    <p>
                      ...
                      developers around the world. From AdWords to rome, Android
                      to Ye, Social to Local, Google engineers are changing the
                      world. From AdWords to Chrome, Aoid to Ye, Social to.
                    </p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div className="jp_listing_overview_list_main_wrapper education_board jb_cover">
                          ...
                          <div className="jp_listing_list_icon_cont_wrapper">
                            ...
                            <p>
                              As a UI/UX Designer, i have a strong background of
                              work closely with Developers and associate with
                              Design Research to enhance design suggestions.
                              Manage design wireframes, mockups and navigation
                              maps. My job was to make sure that my Designs are
                              unique.Develop clean well executed design
                              concepts. Coordinate with team on design and
                              prototype of new interfaces.
                            </p>
                          </div>
                        </div>
                        <div className="jp_listing_overview_list_main_wrapper education_board jb_cover">
                          ...
                          <div className="jp_listing_list_icon_cont_wrapper">
                            ...
                            <p>
                              ...
                              imagination. About our work, we don’t say anything
                              because our work speaks. For more, you can ask our
                              clients and they will tell you how much satisfied
                              they are with our services. So, what are you
                              waiting for?We can develop and design anything
                              beyond your imagination. About our work, we don’t
                              say anything because our work speaks. For more,
                              you can ask our clients and they will tell you how
